...
<?php else: ?>
    ...
    <p><b>SalÃ¡rio CLT (R$):</b> <?php echo e($perfil['salario'] ?? ''); ?></p>
<?php endif; ?>
...
<?php if($usuario_id_logado == $id): ?>
    ...
    <?php endif; ?>
    <a href="<?php echo url('/perfil/excluir'); ?>" onclick="return confirm('Tem certeza que deseja excluir seu perfil? Esta aÃ§Ã£o nÃ£o pode ser desfeita.')">
        <button class="btn-excluir">Excluir perfil</button>
    </a>

<?php endif; ?>

<a href="<?php echo url('/home'); ?>"><button class="btn-voltar">Voltar ao inÃ­cio</button></a>
</div>
